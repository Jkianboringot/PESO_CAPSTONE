...
<head>
    ...
    <!-- Font Awesome (icons used in the panel) -->
    ...
    <div class="min-h-screen flex" style="background:#f0f2f5;">
        ...
        <div class="hidden lg:flex lg:w-2/5 flex-col justify-between px-10 py-12 relative overflow-hidden"
            ...
            <div class="relative">
                <!-- Visible logo -->
                <div class="mb-10">
                    <div class="inline-flex items-center justify-center bg-white rounded-xl p-3 shadow-lg">
                        <img src="{{ asset('pesoLogo.png') }}" alt="PESO Connect" class="h-16 w-auto object-contain">
                    </div>
                </div>

                <div class="text-xs font-semibold uppercase tracking-widest mb-1" style="color:#94a3b8;">Catanduanes Province</div>
                <div class="text-white font-bold text-sm mb-8">PESO Skills Registry</div>
