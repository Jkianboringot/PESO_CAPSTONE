    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        ...
        <div class="rounded-xl p-5 text-white relative overflow-hidden" style="background: #1F4E79;">
            <div class="relative z-10">
                <p class="text-xs font-semibold uppercase tracking-wider opacity-80 mb-1">Total Registered Applicants
                </p>
        ...
        <div class="rounded-xl p-5 text-white relative overflow-hidden" style="background: #00796b;">
            <div class="relative z-10">
        ...
        <div class="rounded-xl p-5 text-white relative overflow-hidden" style="background: #e65100;">
            <div class="relative z-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-2">
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h6 class="text-sm font-bold mb-0.5 group-hover:text-blue-700 transition-colors"
                        style="color: #1e293b;">Applicant Management</h6>
                    <p class="text-xs" style="color: #64748b;">Search, filter, edit, and manage all registered
                        applicants.</p>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('analytics') }}"
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h6 class="text-sm font-bold mb-0.5 group-hover:text-blue-700 transition-colors"
                        style="color: #1e293b;">Workforce Analytics</h6>
                    <p class="text-xs" style="color: #64748b;">Interactive charts for skills, education, barangay and
                        trends.</p>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('reports') }}"
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h6 class="text-sm font-bold mb-0.5 group-hover:text-blue-700 transition-colors"
                        style="color: #1e293b;">Report Generation</h6>
                    <p class="text-xs" style="color: #64748b;">Export DOLE BLE-compliant CSV/Excel reports with filters.
                    </p>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('duplicates') }}"
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h6 class="text-sm font-bold mb-0.5 group-hover:text-blue-700 transition-colors"
                        style="color: #1e293b;">Duplicate Review</h6>
        ...
        <a href="{{ route('skills-gap') }}"
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h6 class="text-sm font-bold mb-0.5 group-hover:text-blue-700 transition-colors"
                        style="color: #1e293b;">Skills Gap Analysis</h6>
                    <p class="text-xs" style="color: #64748b;">Identify underrepresented PQF skill clusters in
                        Catanduanes.</p>
                </div>
            </div>
        </a>
