...
class DuplicateFlag extends Model {
    ...
    public function newApplicant()      { return $this->belongsTo(Applicant::class, 'applicant_id_new'); }
    public function existingApplicant() { return $this->belongsTo(Applicant::class, 'applicant_id_existing'); }
    public function resolvedBy()        { return $this->belongsTo(User::class, 'resolved_by'); }
    public function scopePending($q)    { return $q->where('resolution_status', 'Pending'); }
}
