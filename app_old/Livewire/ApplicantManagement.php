...
use App\Models\{Applicant, Barangay, SkillCategory};
...
class ApplicantManagement extends Component {
    ...
    public function saveEdit(AuditLogService $audit) {
        ...
        $audit->logApplicantUpdated($applicant, ['before' => $before, 'after' => $this->editData]);
    ...
    public function deactivate(int $id, AuditLogService $audit) {
        ...
        session()->flash('success', 'Applicant deactivated.');
    }
